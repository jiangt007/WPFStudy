...
namespace TR.Cloud.Converters
{
    internal static class ShadowInfo
    {
        ...
        static ShadowInfo()
        {
            var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/TR.Cloud;component/Themes/MaterialDesignTheme.Shadows.xaml", UriKind.Absolute) };
